...
static cl::opt<bool> RandomControlFlow("randcf", cl::init(false),
                                       cl::desc("Enable random control flow"));

static cl::opt<bool> FunctionWrapper("funcwra", cl::init(false),cl::desc("Enable function wrapper"));
...
void PassManagerBuilder::populateModulePassManager(
  ...
  MPM.add(createRandom(RandomControlFlow));
  MPM.add(createFunctionWrapperPass(FunctionWrapper));
